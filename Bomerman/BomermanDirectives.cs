...
namespace Bomerman
{
    ...
    class BomClean : FileCommand
    {
        ...
        private string LETypesToString(int[] letypes)
        {
        ...
        private Encoding VSREncodingToEncoding(FileEncoding newFileType)
        {
    ...
    public class BomermanOptions
    {
        ...
        public BomUnstageOptions bonunstage { get; set; }
    }
}
