...
namespace Versionr
{
    ...
    class Options
    {
        ...
        [VerbOption("acquire-lock", HelpText = "Acquires an exclusive lock to a specific path on a server.")]
        public Commands.AcquireLockVerbOptions AcquireLockVerb { get; set; }
